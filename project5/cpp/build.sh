...
SOURCES="src/2D-grid.cpp src/events.cpp src/timestep.cpp src/utils.cpp src/navier-stokes.cpp src/geometry.cpp src/normals.cpp src/vof.cpp src/two-phase.cpp lid.cpp"
